...
<title>{{ __("DashboardAgregarArticulo1") }} | Hacktiva</title>
...
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{ __("DashboardAgregarArticulo1") }}</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">{{ __("DashboardComentarios3") }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/dashboard/articulos">{{ __("DashboardArticulos1") }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">{{ __("DashboardAgregarArticulo1") }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                        ...
                                        <form action="{{ route('dashboard_articulos.agregar') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input name="titulo" id="titulo" placeholder="Ingrese el Título del Artículo" type="text" class="form-control" autocomplete="off" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Cargar Imágen del Artículo</label>
                                                            <br>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Contenido</label>
                                                            <textarea class="ckeditor" name="contenido" name="editor1" id="editor1" rows="10" cols="80">Ingrese el Contenido del Artículo</textarea>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('/dash/app-assets/js/scripts/ui/articulos/data-list-view.js') }}"></script>
    ...
    <script>
        ...
        let menuArticulos = document.getElementById('menuArticulos');
        menuInicio.classList.remove('active');
        menuArticulos.classList.add('active');
    </script>
