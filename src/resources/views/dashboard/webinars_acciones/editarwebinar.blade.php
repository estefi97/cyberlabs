...
<title>Editar Webinar | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Editar Webinar</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">{{ __("DashboardComentarios3") }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/dashboard/webinars">{{ __("DashboardComentarios1") }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">Editar Webinar
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                        ...
                                        <form action="{{ route('dashboard_webinars.editar') }}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input name="titulo" id="titulo" value="{{ $webinar->title }}" type="text" class="form-control" autocomplete="off" required data-validation-required-message="Este campo es obligatorio">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Link Video</label>
                                                            <input name="linkVideo" id="linkVideo" value="{{ $webinar->link_video }}" type="url" class="form-control" autocomplete="off" required data-validation-required-message="Este campo es obligatorio">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <select name="estado" class="form-control" id="basicSelect" required>
                                                                <option value="1" @if ($webinar->status === "1") {{ __("selected") }} @endif>ACTIVO</option>
                                                                <option value="2" @if ($webinar->status === "2") {{ __("selected") }} @endif>NO ACTIVO</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Fecha del Webinar</label>
                                                            <input name="fechaWebinar" id="fechaWebinar" value="{{ $webinar->created_at->format('d-m-Y') }}" type="text" class="form-control" autocomplete="off" required data-validation-required-message="Este campo es obligatorio" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <input type="hidden" name="idWebinar" id="idWebinar" value="{{ $webinar->id }}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
