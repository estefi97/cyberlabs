...
<title>Agregar Usuario | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Agregar Usuario</h2>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                        ...
                                        <form action="{{ route('dashboard_usuarios.agregar') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input name="nombre" id="nombre" placeholder="Ingrese el Nombre del Usuario" type="text" class="form-control" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Apellido</label>
                                                            <input name="apellido" id="apellido" placeholder="Ingrese el Apellido del Usuario" type="text" class="form-control" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <select name="perfilUsuario" class="form-control" id="basicSelect" onchange="HabilitarCamposAdicionales()">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input name="email" id="email" placeholder="Ingrese el Correo Electrónico del Usuario" type="email" class="form-control" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group" id="divStudent" style="display: none;">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Título del Estudiante</label>
                                                            <input name="studentTitle" id="studentTitle" placeholder="Ingrese el Título del Estudiante" type="text" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="form-group" id="divTeacherTitle" style="display: none;">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Título del Profesor</label>
                                                            <input name="teacherTitle" id="teacherTitle" placeholder="Ingrese el Título del Profesor" type="text" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="form-group" id="divTeacherWebsite" style="display: none;">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Sitio Web del Profesor</label>
                                                            <input name="teacherWebsite" id="teacherWebsite" placeholder="Ingrese el Sitio Web del Profesor" type="text" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="form-group" id="divTeacherBiography" style="display: none;">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Biografía del Profesor</label>
                                                            <input name="teacherBiography" id="teacherBiography" placeholder="Ingrese la Biografía del Profesor" type="text" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Contraseña</label>
                                                            <input onchange="checkCamposCompletados()" name="contrasena" id="contrasena" placeholder="Ingrese la Contraseña del Usuario" type="password" class="form-control" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Reingresar Contraseña</label>
                                                            <input onchange="checkCamposCompletados()" name="repetirContrasena" id="repetirContrasena" placeholder="Ingrese nuevamente la Contraseña del Usuario" type="password" class="form-control" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                </div>
