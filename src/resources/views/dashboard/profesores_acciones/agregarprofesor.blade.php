...
<title>Agregar Profesor | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Agregar Profesor</h2>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                        ...
                                        <form action="{{ route('dashboard_profesores.agregar') }}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <select name="usuarioSeleccionado" class="form-control" id="basicSelect">
                                                                @foreach(DB::table('users')->where('role_id','=','3')->select('id','name','last_name')->get() as $user)
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input name="teacherBiography" id="teacherBiography" placeholder="Ingrese el Título del Profesor" type="text" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Sitio Web del Profesor</label>
                                                            <input name="teacherWebsite" id="teacherWebsite" placeholder="Ingrese el Título del Profesor" type="url" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
