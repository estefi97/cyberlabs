...
<title>Auditoría Módulos Cursos | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Auditoría Módulos Cursos</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">{{ __("DashboardArticulos3") }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">Auditoría Módulos Cursos
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <section id="data-list-view" class="data-list-view-header">
                    ...
                    <div class="table-responsive">
                        <table class="table data-list-view">
                            ...
                            <tbody>
                            @forelse($module->withTrashed()->orderBy('updated_at','DESC')->get() as $module)
                                <tr>
                                    <td style="text-align: center;">{{ $module->name }}</td>
                                    <td style="text-align: center;">{{ $module->created_at }}</td>
                                    <td style="text-align: center;">{{ $module->updated_at }}</td>
                                    <td style="text-align: center;">{{ $module->deleted_at }}</td>
                                </tr>
                            @empty
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('/dash/app-assets/js/scripts/ui/auditoria/modulos-data-list-view.js') }}"></script>
    ...
    <script>
        ...
        let menuAuditoriaModulos = document.getElementById('menuAuditoriaModulos');
        menuInicio.classList.remove('active');
        menuAuditoriaModulos.classList.add('active');
    </script>
