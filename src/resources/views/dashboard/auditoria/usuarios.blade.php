...
<title>Auditoría Usuarios | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Auditoría Usuarios</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">{{ __("DashboardArticulos3") }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">Auditoría Usuarios
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('/dash/app-assets/js/scripts/ui/auditoria/usuarios-data-list-view.js') }}"></script>
    ...
    <script>
        ...
        let menuAuditoriaUsuarios = document.getElementById('menuAuditoriaUsuarios');
        menuInicio.classList.remove('active');
        menuAuditoriaUsuarios.classList.add('active');
    </script>
