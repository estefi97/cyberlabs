...
<title>Auditoría Cursos | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Auditoría Cursos</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">{{ __("DashboardArticulos3") }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">Auditoría Cursos
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <section id="data-list-view" class="data-list-view-header">
                    ...
                    <div class="table-responsive">
                        <table class="table data-list-view">
                            ...
                            <tbody>
                            @forelse($course->withTrashed()->orderBy('updated_at','DESC')->get() as $course)
                                <tr>
                                    ...
                                    <td style="text-align: center;">{{ $course->deleted_at }}</td>
                                </tr>
                            @empty
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('/dash/app-assets/js/scripts/ui/auditoria/cursos-data-list-view.js') }}"></script>
    ...
    <script>
        ...
        let menuAuditoriaCursos = document.getElementById('menuAuditoriaCursos');
        menuInicio.classList.remove('active');
        menuAuditoriaCursos.classList.add('active');
    </script>
