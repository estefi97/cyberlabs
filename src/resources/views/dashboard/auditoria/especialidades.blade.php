...
<title>Auditoría Especialidades | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Auditoría Especialidades</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">{{ __("DashboardArticulos3") }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">Auditoría Especialidades
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <section id="data-list-view" class="data-list-view-header">
                    ...
                    <div class="table-responsive">
                        <table class="table data-list-view">
                            ...
                            <tbody>
                            @forelse($specialty->withTrashed()->orderBy('updated_at','DESC')->get() as $specialty)
                                <tr>
                                    <td style="text-align: center;">{{ $specialty->name }}</td>
                                    <td style="text-align: center;">{{ $specialty->created_at }}</td>
                                    <td style="text-align: center;">{{ $specialty->updated_at }}</td>
                                    <td style="text-align: center;">{{ $specialty->deleted_at }}</td>
                                </tr>
                            @empty
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('/dash/app-assets/js/scripts/ui/auditoria/especialidades-data-list-view.js') }}"></script>
    ...
    <script>
        ...
        let menuAuditoriaEspecialidades = document.getElementById('menuAuditoriaEspecialidades');
        menuInicio.classList.remove('active');
        menuAuditoriaEspecialidades.classList.add('active');
    </script>
