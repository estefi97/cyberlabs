...
<title>Auditoría Webinars | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Auditoría Webinars</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">{{ __("DashboardArticulos3") }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">Auditoría Webinars
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <section id="data-list-view" class="data-list-view-header">
                    ...
                    <div class="table-responsive">
                        <table class="table data-list-view">
                            ...
                            <tbody>
                            @forelse($webinar->withTrashed()->orderBy('updated_at','DESC')->get() as $webinar)
                                <tr>
                                    <td style="text-align: center;">{{ $webinar->title }}</td>
                                    <td style="text-align: center;">{{ $webinar->created_at }}</td>
                                    <td style="text-align: center;">{{ $webinar->updated_at }}</td>
                                    <td style="text-align: center;">{{ $webinar->deleted_at }}</td>
                                </tr>
                            @empty
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('/dash/app-assets/js/scripts/ui/auditoria/webinars-data-list-view.js') }}"></script>
    ...
    <script>
        ...
        let menuAuditoriaWebinars = document.getElementById('menuAuditoriaWebinars');
        menuInicio.classList.remove('active');
        menuAuditoriaWebinars.classList.add('active');
    </script>
