...
<title>Auditoría Artículos | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Auditoría Artículos</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">{{ __("DashboardArticulos3") }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">Auditoría Artículos
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <section id="data-list-view" class="data-list-view-header">
                    ...
                    <div class="table-responsive">
                        <table class="table data-list-view">
                            ...
                            <tbody>
                            @forelse($article->withTrashed()->orderBy('updated_at','DESC')->get() as $article)
                                <tr>
                                    <td style="text-align: center;">{{ $article->title }}</td>
                                    <td style="text-align: center;">{{ $article->created_at }}</td>
                                    <td style="text-align: center;">{{ $article->updated_at }}</td>
                                    <td style="text-align: center;">{{ $article->deleted_at }}</td>
                                </tr>
                            @empty
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('/dash/app-assets/js/scripts/ui/auditoria/articulos-data-list-view.js') }}"></script>
    ...
    <script>
        ...
        let menuAuditoriaArticulos = document.getElementById('menuAuditoriaArticulos');
        menuInicio.classList.remove('active');
        menuAuditoriaArticulos.classList.add('active');
    </script>
