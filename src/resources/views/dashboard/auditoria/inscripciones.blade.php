...
<title>Auditoría Inscripciones | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Auditoría Inscripciones</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">{{ __("DashboardArticulos3") }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">Auditoría Inscripciones
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <section id="data-list-view" class="data-list-view-header">
                    ...
                    <div class="table-responsive">
                        <table class="table data-list-view">
                            ...
                            <tbody>
                            @forelse(DB::table('module_user')->select('module_id','user_id','created_at','updated_at','deleted_at')->orderBy('updated_at','DESC')->get() as $inscripcion)
                                <tr>
                                    <td style="text-align: center;">{{ DB::table('courses')->select('name')->where('id','=',DB::table('module_course')->select('course_id')->where('module_id','=',$inscripcion->module_id)->first()->course_id)->first()->name }}</td>
                                    ...
                                    <td style="text-align: center;">{{ $inscripcion->updated_at }}</td>
                                    <td style="text-align: center;">{{ $inscripcion->deleted_at }}</td>
                                </tr>
                            @empty
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('/dash/app-assets/js/scripts/ui/auditoria/inscripciones-data-list-view.js') }}"></script>
    ...
    <script>
        ...
        let menuAuditoriaInscripciones = document.getElementById('menuAuditoriaInscripciones');
        menuInicio.classList.remove('active');
        menuAuditoriaInscripciones.classList.add('active');
    </script>
