...
<title>Auditoría Profesores | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Auditoría Profesores</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">{{ __("DashboardArticulos3") }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">Auditoría Profesores
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <section id="data-list-view" class="data-list-view-header">
                    ...
                    <div class="table-responsive">
                        <table class="table data-list-view">
                            ...
                            <tbody>
                            @forelse($teacher->withTrashed()->orderBy('updated_at','DESC')->get() as $teacher)
                                <tr>
                                    <td style="text-align: center;">{{ DB::table('users')->select('name')->where('id','=',$teacher->user_id)->first()->name }} {{ DB::table('users')->select('last_name')->where('id','=',$teacher->user_id)->first()->last_name }}</td>
                                    <td style="text-align: center;">{{ $teacher->created_at }}</td>
                                    <td style="text-align: center;">{{ $teacher->updated_at }}</td>
                                    <td style="text-align: center;">{{ $teacher->deleted_at }}</td>
                                </tr>
                            @empty
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('/dash/app-assets/js/scripts/ui/auditoria/profesores-data-list-view.js') }}"></script>
    ...
    <script>
        ...
        let menuAuditoriaProfesores = document.getElementById('menuAuditoriaProfesores');
        menuInicio.classList.remove('active');
        menuAuditoriaProfesores.classList.add('active');
    </script>
