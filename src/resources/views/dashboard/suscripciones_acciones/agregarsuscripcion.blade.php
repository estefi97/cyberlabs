...
<title>Agregar Suscripción | Hacktiva</title>
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Agregar Suscripción</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Agregar Suscripción
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                        ...
                                        <form action="{{ route('dashboard_suscripciones.agregar') }}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <select name="usuarioSeleccionado" class="form-control" id="basicSelect">
                                                                @forelse(DB::table('users')->select('id','name','last_name')->get() as $user)
                                                                    @if(DB::table('subscriptions')->where(['user_id' => $user->id])->count() > 0)
                                                                        @foreach(DB::table('subscriptions')->where(['user_id' => $user->id])->get() as $userSubscriptions)
                                                                            @if(\Carbon\Carbon::now()->lt($userSubscriptions->ends_at) === false)
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input name="fechaComienzoSuscripcion" value="{{ \Carbon\Carbon::now()->toDateString() }}" id="fechaComienzoSuscripcion" placeholder="Ingrese la Fecha de Inicio de la Suscripción" type="date" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label class="label-dashboard">Fecha de Finalización de la Suscripción</label>
                                                            <input name="fechaFinSuscripcion" value="{{ \Carbon\Carbon::now()->addMonth(1)->toDateString() }}" id="fechaFinSuscripcion" placeholder="Ingrese la Fecha de Finalización de la Suscripción" type="date" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
