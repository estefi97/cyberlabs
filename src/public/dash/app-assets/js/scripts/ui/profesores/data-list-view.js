$(document).ready(function () {
  ...
  if (idiomaPaginaWeb === "en") {
    textoBotonAgregarArticulo = "Add Teacher";
  }

  if (idiomaPaginaWeb === "es") {
    textoBotonAgregarArticulo = "Agregar Profesor";
  }
  ...
  $(".deleteBtn").on("click", function () {
    ...
    document.getElementById("idProfesorSeleccionado").value =
    ...
    buttons: [
      {
        ...
        action: function () {
          window.location = "profesores/agregar";
        },
