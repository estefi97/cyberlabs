$(document).ready(function () {
  ...
  if (idiomaPaginaWeb === "en") {
    textoBotonAgregarArticulo = "Add Specialty";
  }

  if (idiomaPaginaWeb === "es") {
    textoBotonAgregarArticulo = "Agregar Especialidad";
  }
  ...
  $(".deleteBtn").on("click", function () {
    ...
    document.getElementById("idEspecialidadSeleccionada").value =
    ...
    buttons: [
      {
        ...
        action: function () {
          window.location = "especialidades/agregar";
        },
