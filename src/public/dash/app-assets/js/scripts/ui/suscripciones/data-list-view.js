$(document).ready(function () {
  ...
  if (idiomaPaginaWeb === "en") {
    textoBotonAgregarArticulo = "Add Subscription";
  }

  if (idiomaPaginaWeb === "es") {
    textoBotonAgregarArticulo = "Agregar Suscripción";
  }
    ...
    buttons: [
      {
        ...
        action: function () {
          window.location = "suscripciones/agregar";
        },
