$(document).ready(function () {
  ...
  if (idiomaPaginaWeb === "en") {
    textoBotonAgregarArticulo = "Add Article";
  }

  if (idiomaPaginaWeb === "es") {
    textoBotonAgregarArticulo = "Agregar Artículo";
  }
  ...
  $(".deleteBtn").on("click", function () {
    ...
    document.getElementById("idArticuloSeleccionado").value =
    ...
    buttons: [
      {
        ...
        action: function () {
          window.location = "articulos/agregar";
        },
