$(document).ready(function () {
  ...
  if (idiomaPaginaWeb === "en") {
    textoBotonAgregarArticulo = "Add Webinar";
  }

  if (idiomaPaginaWeb === "es") {
    textoBotonAgregarArticulo = "Agregar Webinar";
  }
    ...
    buttons: [
      {
        ...
        action: function () {
          window.location = "webinars/agregar";
        },
