$(document).ready(function () {
  ...
  if (idiomaPaginaWeb === "en") {
    textoBotonAgregarArticulo = "Add Module";
  }

  if (idiomaPaginaWeb === "es") {
    textoBotonAgregarArticulo = "Agregar Módulo";
  }
    ...
    buttons: [
      {
        ...
        action: function () {
          window.location = "modulos-cursos/agregar";
        },
